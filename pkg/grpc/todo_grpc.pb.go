...
type TodoServiceClient interface {
	...
	Get(ctx context.Context, in *GetTodosRequest, opts ...grpc.CallOption) (*GetTodosResponse, error)
...
func (c *todoServiceClient) Get(ctx context.Context, in *GetTodosRequest, opts ...grpc.CallOption) (*GetTodosResponse, error) {
...
type TodoServiceServer interface {
	...
	Get(context.Context, *GetTodosRequest) (*GetTodosResponse, error)
...
func (UnimplementedTodoServiceServer) Get(context.Context, *GetTodosRequest) (*GetTodosResponse, error) {
...
func _TodoService_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TodoServiceServer).Get(ctx, req.(*GetTodosRequest))
	}
	return interceptor(ctx, in, info, handler)
}
